...
#Aug 17
in.dir = "U://SatelliteData//Worldview//Processed//20190817//RF//"
...
#Aug 11
in.dir = "U://SatelliteData//Worldview//Processed//20190811//RF//FinalwithMF"
dir.use = list.dirs(in.dir, recursive=F)
...
#S-2
in.csv="U://SatelliteData//Fixed-20160913//Processed//RFResultv2//FinalModels//S2-v2//cvrun//"
tp = fun.tp(in.csv)
fp =fun.fp(in.csv)
fn = fun.fn(in.csv)
f1 = fun.f1(tp,fp,fn)
